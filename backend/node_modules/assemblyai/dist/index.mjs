...
const defaultUserAgent = {
    sdk: { name: "JavaScript", version: "4.38.0" },
};
    ...
    transcribe(audio_1) {
        return __awaiter(this, arguments, void 0, function* (audio, config = {}, options = {}) {
            ...
            if (response.status !== 200)
                throw yield errorFromResponse$1(response);
 ...
 */
function errorFromResponse$1(response) {
    return __awaiter(this, void 0, void 0, function* () {
        let errorCode;
        let message;
        const text = yield response.text();
...
class LlmGatewayService extends BaseService {
    ...
    chatCompletions(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.fetchResponse("/v1/chat/completions", {
                method: "POST",
    ...
    listModels() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.fetchResponse("/v1/models", {
                method: "GET",
            });
            if (!response.ok)
                throw yield errorFromResponse(response);
    ...
    understanding(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.fetchResponse("/v1/understanding", {
                method: "POST",
                body: JSON.stringify(request),
            });
            if (!response.ok)
    ...
    validateUnderstanding(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.fetchResponse("/v1/understanding/validate", {
                method: "POST",
                body: JSON.stringify(request),
            });
            if (!response.ok)
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (body && typeof body === "object" && !Array.isArray(body)) {
                ...
                if (Array.isArray((_a = body.metadata) === null || _a === void 0 ? void 0 : _a.errors))
...
class RealtimeTranscriber {
    ...
    waitForTermination(sessionTerminated, timeoutMs) {
        return __awaiter(this, void 0, void 0, function* () {
            if (timeoutMs <= 0) {
                yield sessionTerminated;
                return;
            }
            let timer;
            try {
     ...
     */
    close() {
        return __awaiter(this, arguments, void 0, function* (waitForSessionTermination = true, terminationTimeout = DEFAULT_TERMINATION_TIMEOUT_MS$1) {
            var _a;
            if (this.socket) {
                if (this.socket.readyState === this.socket.OPEN) {
                    if (waitForSessionTermination) {
                        ...
                        yield this.waitForTermination(sessionTerminatedPromise, terminationTimeout);
                    }
                    else {
                        this.socket.send(terminateSessionMessage$1);
                    }
...
class StreamingTranscriber {
     ...
     */
    close() {
        return __awaiter(this, arguments, void 0, function* (waitForSessionTermination = true, terminationTimeout = DEFAULT_TERMINATION_TIMEOUT_MS) {
            var _a;
            if (this.flushTimer) {
                clearInterval(this.flushTimer);
                this.flushTimer = undefined;
...
class AssemblyAI {
    ...
    constructor(params) {
        ...
        this.llmGateway = new LlmGatewayService(Object.assign(Object.assign({}, params), { baseUrl: llmGatewayBaseUrl }));
    }
}

export { AssemblyAI, BrowserOnlyError, DualChannelCapture, EnergyVad, FileService, LinearResampler, LlmGatewayError, LlmGatewayService, RealtimeService, RealtimeServiceFactory, RealtimeTranscriber, RealtimeTranscriberFactory, StreamingTranscriber, SyncTranscriber, SyncTranscriptError, TranscriptService, VadTimeline, attributeTurn, attributeWord, defaultSyncSpeechModel, float32ToPcm16, rollUpTurnChannel };
